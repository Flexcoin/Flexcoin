...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits() //disable the unit choice to avoid confusion
{
    ...
    unitlist.append(infinitemoneycoin);
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case infinitemoneycoin:
            return QString("IMC");
        case mECA:
            return QString("Milli-IMC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-IMC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case infinitemoneycoin:
            return QString("TestIMC");
        case mECA:
            return QString("Milli-TestIMC (1 / 1" THIN_SP_UTF8 "000)");
        case uECA:
            return QString("Micro-TestIMC (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
