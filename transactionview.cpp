 ...
 */
    ...
    typeWidget->addItem(tr("Received infinitemoneycoin from zIMC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zIMC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zEca));
