...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("infinitemoneycoin infinitemoneycoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  infinitemoneycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded infinitemoneycoin transaction") + "\n" +
                               "  infinitemoneycoin-tx [options] -create [commands]   " + _("Create hex-encoded infinitemoneycoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded infinitemoneycoin transaction
