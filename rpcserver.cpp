...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop infinitemoneycoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "infinitemoneycoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* infinitemoneycoin features */
        {"infinitemoneycoin", "masternode", &masternode, true, true, false},
        {"infinitemoneycoin", "listmasternodes", &listmasternodes, true, true, false},
        {"infinitemoneycoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"infinitemoneycoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"infinitemoneycoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"infinitemoneycoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"infinitemoneycoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"infinitemoneycoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"infinitemoneycoin", "masternodedebug", &masternodedebug, true, true, false},
        {"infinitemoneycoin", "startmasternode", &startmasternode, true, true, false},
        {"infinitemoneycoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"infinitemoneycoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"infinitemoneycoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"infinitemoneycoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"infinitemoneycoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"infinitemoneycoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"infinitemoneycoin", "mnbudget", &mnbudget, true, true, false},
        {"infinitemoneycoin", "preparebudget", &preparebudget, true, true, false},
        {"infinitemoneycoin", "submitbudget", &submitbudget, true, true, false},
        {"infinitemoneycoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"infinitemoneycoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"infinitemoneycoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"infinitemoneycoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"infinitemoneycoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"infinitemoneycoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"infinitemoneycoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"infinitemoneycoin", "checkbudgets", &checkbudgets, true, true, false},
        {"infinitemoneycoin", "mnsync", &mnsync, true, true, false},
        {"infinitemoneycoin", "spork", &spork, true, true, false},
        {"infinitemoneycoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> infinitemoneycoin-cli " + methodname + " " + args + "\n";
}
