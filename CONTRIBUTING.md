Contributing to infinitemoneycoin Core
============================

The infinitemoneycoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the infinitemoneycoin Core project, and is not to be
confused with overall infinitemoneycoin Network Protocol consensus changes.

Whether a pull request is merged into infinitemoneycoin Core rests with the project merge
...
Patches that change infinitemoneycoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the infinitemoneycoin consensus, it must have been
...
The project leader is the release manager for each infinitemoneycoin Core release.
