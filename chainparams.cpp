...
public:
    CMainParams()
    {
        ...
        nTargetSpacing = 600; // 600 seconds
        nMaturity = 10;
        ...
        nEnforceNewSporkKey = 1525158000;                           // Sporks signed after (IMC): Tuesday, May 1, 2018 7:00:00 AM IMC must use the new spork key
        nRejectOldSporkKey = 1527811200;                            // Fully reject old spork key after (IMC): Friday, June 1, 2018 12:00:00 AM

        const char* pszTimestamp = "infinitemoneycoin is born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1622686407;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 5502593;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xd8d42eb7ed6d1f76e403c831d524e66f95533ff975679094d1434aed70a2f61f"));
        assert(hashGenesisBlock == uint256("0x00000622f4eb11791582ee18bfdd2b7697c05f74f590a14d6a42bb7b686c4953"));

     
		
	vSeeds.push_back(CDNSSeedData("66.42.84.225","66.42.84.225"));
        ...
        nStartMasternodePayments = 1403728576; //Wed, 25 Jun 2014 20:36:16 IMC
...
public:
    CTestNetParams()
    {
        ...
        nModifierUpdateBlock = -1; //approx Mon, 17 Apr 2017 04:00:00 IMC
        ...
        nBlockZerocoinV2 = nZerocoinStartHeight + 20; //!> The block that zerocoin v2 becomes active
        nEnforceNewSporkKey = 1521604800; //!> Sporks signed after Wednesday, March 21, 2018 4:00:00 AM IMC must use the new spork key
        nRejectOldSporkKey = 1522454400; //!> Reject old spork key after Saturday, March 31, 2018 12:00:00 AM IMC

        //! Modify the testnet genesis block so the timestamp is valid for a later start.
        genesis.nTime = 1612138687;
        genesis.nBits = bnProofOfWorkLimit.GetCompact(); //0x1f00ffff;
        genesis.nNonce = 1006735;
        ...
        assert(genesis.hashMerkleRoot == uint256("0xd8d42eb7ed6d1f76e403c831d524e66f95533ff975679094d1434aed70a2f61f"));
        assert(hashGenesisBlock == uint256("0x0000576b3f320bbfff4ed62c52fb69a6ccead9064c25002f3de6a05a7a7f327d"));
        ...
        nStartMasternodePayments = 1420837558; //Fri, 09 Jan 2015 21:05:58 IMC
...
public:
    CRegTestParams()
    {
        ...
        assert(genesis.hashMerkleRoot == uint256("0xd8d42eb7ed6d1f76e403c831d524e66f95533ff975679094d1434aed70a2f61f"));
        assert(hashGenesisBlock == uint256("0x3aa9892c7f9153e19f3c7dcaf50c1815dcc3033fd5a23b5dae190f77d6c105f3"));
