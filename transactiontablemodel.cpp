...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::StakeMint:
        return tr("infinitemoneycoin Stake");
    case TransactionRecord::StakeZECA:
        return tr("zIMC Stake");
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted infinitemoneycoin to zIMC");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zIMC");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received infinitemoneycoin from zIMC");
    case TransactionRecord::ZerocoinSpend_Change_zEca:
        return tr("Minted Change as zIMC from zIMC Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zIMC to infinitemoneycoin");
...
QString TransactionTableModel::formatTxToAddress(const TransactionRecord* wtx, bool tooltip) const
{
    ...
    case TransactionRecord::ZerocoinMint:
    case TransactionRecord::ZerocoinSpend_Change_zEca:
        return tr("Anonymous (zIMC Transaction)");
    case TransactionRecord::StakeZECA:
        return tr("Anonymous (zIMC Stake)");
    case TransactionRecord::SendToSelf:
    default:
