...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::infinitemoneycoin);
    ...
    if (!settings.contains("nAnonymizeinfinitemoneycoinAmount"))
        settings.setValue("nAnonymizeinfinitemoneycoinAmount", 1000);

    nAnonymizeinfinitemoneycoinAmount = settings.value("nAnonymizeinfinitemoneycoinAmount").toLongLong();
...
// Wallet
    ...
    if (settings.contains("nAnonymizeinfinitemoneycoinAmount"))
        SoftSetArg("-anonymizeinfinitemoneycoinamount", settings.value("nAnonymizeinfinitemoneycoinAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in infinitemoneycoin.cpp during shotdown to also remove the window positions
...
//            return settings.value("fShowMasternodesTab");
        ...
        case AnonymizeinfinitemoneycoinAmount:
            return QVariant(nAnonymizeinfinitemoneycoinAmount);
        case Listen:
...
//            break;
        ...
        case AnonymizeinfinitemoneycoinAmount:
            nAnonymizeinfinitemoneycoinAmount = value.toInt();
            settings.setValue("nAnonymizeinfinitemoneycoinAmount", nAnonymizeinfinitemoneycoinAmount);
            emit anonymizeinfinitemoneycoinAmountChanged(nAnonymizeinfinitemoneycoinAmount);
            break;
        case CoinControlFeatures:
