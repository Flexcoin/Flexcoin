                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("InfiniteMoneyCoin Wallet") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    webmainAction = new QAction(QIcon(":/icons/explorer"), tr("&infinitemoneycoin Project"), this);
    webmainAction->setStatusTip(tr("infinitemoneycoin Project Website"));
    ...
    facebookAction->setStatusTip(tr("infinitemoneycoin Facebook"));
    ...
    twitterAction->setStatusTip(tr("infinitemoneycoin Twitter"));
    ...
    discordAction->setStatusTip(tr("infinitemoneycoin Discord"));
    ...
    youtubeAction->setStatusTip(tr("infinitemoneycoin Youtube"));
    ...
    telegramAction->setStatusTip(tr("infinitemoneycoin Telegram"));
    ...
    redditAction->setStatusTip(tr("infinitemoneycoin Reddit"));
    ...
    cmcAction->setStatusTip(tr("CoinMarketCap infinitemoneycoin"));
    ...
    exchangesAction->setStatusTip(tr("Markets to buy and sell infinitemoneycoin Coin (infinitemoneycoin)"));
    exchangesAction->setToolTip(exchangesAction->statusTip());
    exchangesAction->setCheckable(true);
    infinitemoneycoinBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&infinitemoneycoin block explorer"), this);
    infinitemoneycoinBlockExplorerAction->setStatusTip(tr("infinitemoneycoin blockchain explorer"));
    infinitemoneycoinBlockExplorerAction->setToolTip(infinitemoneycoinBlockExplorerAction->statusTip());
    infinitemoneycoinBlockExplorerAction->setCheckable(true);
    githubAction = new QAction(QIcon(":/icons/github"), tr("&infinitemoneycoin Project Github"), this);
    githubAction->setStatusTip(tr("infinitemoneycoin Project Github"));
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a infinitemoneycoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and infinitemoneycoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zIMC"));
...
//    }
    ...
    connect(infinitemoneycoinBlockExplorerAction, SIGNAL(triggered()), this, SLOT(infinitemoneycoinBlockExplorerActionClicked()));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About infinitemoneycoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about infinitemoneycoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for infinitemoneycoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your infinitemoneycoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified infinitemoneycoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a infinitemoneycoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the infinitemoneycoin Core help message to get a list with possible infinitemoneycoin command-line options"));
...
void BitcoinGUI::createMenuBar()
{
    ...
    help->addAction(aboutQtAction);
	  ...
	  QMenu* Links = appMenuBar->addMenu(tr("&Links"));
		...
		Links->addAction(infinitemoneycoinBlockExplorerAction);
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("infinitemoneycoin Core client") + " " + networkStyle->getTitleAddText();
...
{
	QDesktopServices::openUrl(QUrl("https://www.infinitemoneycoin.net"));
}
void BitcoinGUI::facebookActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://www.facebook.com/infinitemoneycoin.coin"));
}
void BitcoinGUI::twitterActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://twitter.com/infinitemoneycoin4"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://t.me/infinitemoneycoincryptocurrency"));
}
...
{
        QDesktopServices::openUrl(QUrl("https://www.reddit.com/user/infinitemoneycoin-coin"));
}
void BitcoinGUI::exchangesActionClicked()
{
        QDesktopServices::openUrl(QUrl("https://"));
}
void BitcoinGUI::infinitemoneycoinBlockExplorerActionClicked()
{
...
{
	QDesktopServices::openUrl(QUrl("https://github.com/infinitemoneycoin/infinitemoneycoin/"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to infinitemoneycoin network", "", count));
}
...
{
    QString strTitle = tr("infinitemoneycoin Core"); // default title
    ...
    // Append title to "infinitemoneycoin - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
