...
/** Utility functions used by the infinitemoneycoin Qt UI.
 */
namespace GUIUtil
{
...
// Render infinitemoneycoin addresses in monospace font
...
// Parse "infinitemoneycoin:" URI into recipient object, return true on successful parsing
