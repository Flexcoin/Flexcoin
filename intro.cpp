...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("infinitemoneycoin Core"),
     ...
     * override -datadir in the infinitemoneycoin.conf file in the default data directory
     * (to be consistent with infinitemoneycoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
